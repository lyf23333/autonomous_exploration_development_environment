...
def point_cloud_publisher():
    ...
    home_path = "/home/yifa/git/swiss_mile/navigation/rl_global_planner/log/ETH_HG"
    files_path = ['trajectory_2024-5-23-23-34-26_run_0.txt',
                  "trajectory_2024-5-24-0-6-26_run_1.txt",
                  "trajectory_2024-5-24-0-15-38_run_2.txt",
                  "trajectory_2024-5-24-0-28-43_run_3.txt",
                  "trajectory_2024-6-2-10-27-11_run0.txt"]  # Path to the text files
    color_list = [
                    [204, 0, 0],
                    [245, 121, 0],
                    [237, 212, 0],
