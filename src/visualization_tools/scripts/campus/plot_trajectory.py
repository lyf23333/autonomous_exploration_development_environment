...
def point_cloud_publisher():
    ...
    files_path = ['trajectory_2024-5-24-13-19-23_run_0.txt',
                  "trajectory_2024-5-24-14-16-43_run_1.txt",
                  "trajectory_2024-5-24-16-34-22_run_2.txt",
                  "trajectory_2024-5-24-16-54-3_run_3.txt",
                  "trajectory_2024-5-24-17-8-6_run_4.txt"]  # Path to the text files
    color_list = [
                    [204, 0, 0],
                    [245, 121, 0],
                    [237, 212, 0],
