...
ax.bar(indices, travel_times_method1, bar_width, label='LB', color = 'tab:green')
ax.bar(indices + bar_width, travel_times_method2, bar_width, label='FAR', color = 'tab:orange')
