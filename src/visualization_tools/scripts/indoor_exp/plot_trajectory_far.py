...
def point_cloud_publisher():
    ...
    home_path = "/home/yifa/paper/autonomous_exploration_development_environment/src/vehicle_simulator/log/indoor_exp"
    files_path = ['trajectory_2024-5-21-23-4-24_run_0.txt']  # Path to the text files
    color_list = [
                    [204, 0, 0],
                    [245, 121, 0],
                    [237, 212, 0],
